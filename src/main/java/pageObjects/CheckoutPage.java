...
public class CheckoutPage {
	...
	public void select_Country(String countryName) {
		SelenieumUtility.selectByVisibleText(drpdwn_CountryDropDownArrow, countryName);
	}

	public void select_County(String countyName) {
		SelenieumUtility.selectByVisibleText(drpdwn_CountyDropDownArrow, countyName);
	}
